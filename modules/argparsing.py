...
parser.add_argument('-fa', '--followersamount', type=int, metavar='numfollowers', help='number of followers to process (default=all)', default=None)
...
parser.add_argument('-ls', '--likestory', type=int, nargs='?', metavar='numstories', help='like stories (default=all)', const=float('inf'))
parser.add_argument('-cs', '--commentstory', type=int, nargs='?', metavar='numcomments', help='comments on stories (no comments if option not used)', const=float('inf'))
...
parser.add_argument('-bp', '--brprofile', type=str, metavar='', help='loads chrome profile from a path', default=None)
parser.add_argument('-et', '--eltimeout',  type=str, metavar='', help='max time to wait for elements to be loaded (default=30)', default=30)
parser.add_argument('-d', '--delay', type=str, metavar='min,max', help='time to wait during post switch default=1,10', default='1,10')
